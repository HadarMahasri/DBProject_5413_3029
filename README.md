...
## שלב ה: ממשק גרפי
### מסך התחברות
התחברות עם משתממש קבוע, שם משתמש:admin סיסמה:1234. כאשר בסיס הנתונים פעמים תהיה הצלחה בהתחברות ונגיע למסך הראשי.
![image](https://github.com/user-attachments/assets/de31c09b-333a-48a6-a148-95fb6153dbdf)

### מסך ראשי
מסך שממנו ניתן לגשת לכל הפונקציונליות של המערכת.
![image](https://github.com/user-attachments/assets/53a2e8d6-2be3-47d3-97cb-6ebd87a2dc46)
