...
<p dir="rtl">- <a href="#שלב-א-עיצוב-ויצירת-מסד-נתונים">שלב א: עיצוב ויצירת מסד נתונים</a></p>  - [מבוא](#מבוא)  
  - [תיאור המערכת](#תיאור-המערכת)  
  - [תשריטי מערכת](#תשריטי-מערכת)  
  - [דיאגרמת ישות־קשר - ERD](#דיאגרמת-ישות־קשר---erd)  
  - [דיאגרמת סכמת נתונים - DSD](#דיאגרמת-סכמת-נתונים---dsd)  
  - [החלטות עיצוב](#החלטות-עיצוב)  
  - [מבנה הטבלאות](#מבנה-הטבלאות)  
  - [הכנסת נתונים](#הכנסת-נתונים)  
  - [גיבוי](#גיבוי)

- [שלב ב: שאילותת](#שלב-ב-שאילתות)  
