...
Paramedic - מידע על הפרמדיקים (מזהה, שם, ניסיון)


Treatment - מידע על הטיפולים שניתנו (משך, סוג, תאריך)
</div>
...
Operation - מידע על המבצעים (שם, מיקום, תאריכים)
Executed_by - טבלת קשר בין מבצעים ליחידות
Unit - מידע על היחידות (שם, כמות חיילים)
Corps - מידע על החילות (שם, התמחות)
